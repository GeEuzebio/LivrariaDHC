...
namespace LibraryApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber,SIGE,Class")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Email,PhoneNumber,SIGE,Class")] User user)
        {
            if (id != user.UserId)
            {
                return _signInManager.IsSignedIn(User) ? NotFound() : Redirect("/Home");
